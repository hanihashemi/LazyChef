...
import io.github.hanihashemi.lazychef.androidApp.Screen.Recipe
import io.github.hanihashemi.lazychef.androidApp.ScreenName.HOME
import io.github.hanihashemi.lazychef.androidApp.ScreenName.RECIPE
import io.github.hanihashemi.lazychef.androidApp.utils.getMutableStateOf
...
sealed class Screen(val id: ScreenName) {
    ...
    data class Recipe(val recipeId: String) : Screen(RECIPE)
}
...
private const val SIS_RECIPE = "post"
